...
class LinkedList:
    def __init__(self, data: Iterable = None):
        ...
        self.len = 0 #списка может и не быть    # TODO атрибут, хранящий длину последовательности
    ...
    def init_linked_list(self, data: Iterable):
        ...
        self.head = self.list_nodes[0] # первый элемент равен первому элементу из списка
    ...
    def step_by_step_on_nodes(self, index: int) -> Node:
        ...
        if not 0 <= index < self.len:    # TODO проверка корректности границ индекса
            raise IndexError() # индекс не может быть меньше списка и больше длины списка
