...
if __name__ == "__main__":
    ...
    print(glass1.capacity_volume, glass1.occupied_volume) #ссылки
    ...
    glass1.occupied_volume = glass1.capacity_volume + 200#  TODO доливаем воды в первый стакан
    glass1.occupied_volume = glass1.occupied_volume + 200
