...
class Glass:
    ...
    def __str__(self) -> str:
        return f"объем стакана = {self.capacity_volume}, обьем жидкости {self.occupied_volume}"  # TODO метод должен возвращать строку, которая содержит человеко-читаемую информацию
